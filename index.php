...
<head>
    ...
    <link rel="stylesheet" href="https://htmlguru.net/carrent-html/assets/css/style.css">
    <link rel="stylesheet" href="https://htmlguru.net/carrent-html/assets/css/color-schemer.css">
...
<body>
        ...
        <div class="container">        
            <div class="row">
                <div class="col-md-3 col-sm-10 col-xs-10">
                    <div class="site-logo">
                        <a href="index.html"><img src="assets/images/taxi-malibu.jpg" alt="logo" width="30%"/></a>
                    </div><!-- /.logo -->
                </div><!-- /.col-md-3 -->
                ...
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="materialize Material" data-description="">
                        ...
                        <div class="tp-caption rev-subheading tp-resizeme"
                            ...
                            data-splitout="none" 
                            data-responsive_offset="on"
                            style="z-index: 5; color: #464646; font-weight: 600; font-family: inherit;">El mejor alquiler de carros del mundo!!!!!
                        </div>
            ...
            <div class="row tb default-margin-bottom yellow-theme">
                ...
                <div class="col-md-9 col-sm-8 block-title-area tb-cell">
                    <div class="heading-content style-one border">
                        ...
                        <h2 class="title">Popular Taxi</h2>
            ...
            <div class="vehicle-slider slider-style-two owl-carousel" data-item="[4,2,1,1]">
                <div class="item">
                    <div class="vehicle-content theme-yellow">
                        <div class="vehicle-thumbnail">
                            <a href="#">
                                <img src="https://htmlguru.net/carrent-html/assets/images/popular/popular-01.png" alt="car-item" />
                            </a>
                ...
                <div class="item">
                    <div class="vehicle-content theme-yellow">
                        <div class="vehicle-thumbnail">
                            <a href="#">
                                <img src="https://htmlguru.net/carrent-html/assets/images/popular/popular-02.png" alt="car-item" />
                            </a>
                        </div><!-- /.vehicle-thumbnail -->
                            <div class="vehicle-bottom-content">
                               <h2 class="vehicle-title"><a href="#">Toyota Aygo</a></h2>
                ...
                <div class="item">
                    <div class="vehicle-content theme-yellow">
                        <div class="vehicle-thumbnail">
                            <a href="#">
                                <img src="https://htmlguru.net/carrent-html/assets/images/popular/popular-03.png" alt="car-item" />
                            </a>
                        </div><!-- /.vehicle-thumbnail -->
                            <div class="vehicle-bottom-content">
                               <h2 class="vehicle-title"><a href="#">Toyota Aygo</a></h2>
                ...
                <div class="item">
                    <div class="vehicle-content theme-yellow">
                        <div class="vehicle-thumbnail">
                            <a href="#">
                                <img src="https://htmlguru.net/carrent-html/assets/images/popular/popular-04.png" alt="car-item" />
                            </a>
                        </div><!-- /.vehicle-thumbnail -->
                            <div class="vehicle-bottom-content">
                               <h2 class="vehicle-title"><a href="#">Toyota Aygo</a></h2>
                ...
                <div class="item row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="https://htmlguru.net/carrent-html/assets/images/popular/popular-05.png" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                            <div class="vehicle-bottom-content">
                               <h2 class="vehicle-title"><a href="#">Toyota Aygo</a></h2>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="https://htmlguru.net/carrent-html/assets/images/popular/popular-06.png" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                            <div class="vehicle-bottom-content">
                               <h2 class="vehicle-title"><a href="#">Toyota Aygo</a></h2>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="https://htmlguru.net/carrent-html/assets/images/popular/popular-07.png" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                            <div class="vehicle-bottom-content">
                               <h2 class="vehicle-title"><a href="#">Toyota Aygo</a></h2>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="https://htmlguru.net/carrent-html/assets/images/popular/popular-08.png" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                            <div class="vehicle-bottom-content">
                               <h2 class="vehicle-title"><a href="#">Toyota Aygo</a></h2>
    ...
    <!-- ======fun facts block======= -->
    <div class="fun-facts-block background-overlay" style="background-image:url(https://htmlguru.net/carrent-html/assets/images/fun-fect-image.png)">
        <div class="container">
            <div class="stat">
            ...
            <div class="driver-carousel slider-style-two owl-carousel" data-item="[4,2,2,1]">
                <div class="item">
                    <div class="driver-content vehicle-content theme-yellow">
                        <div class="driver-thumb vehicle-thumbnail">
                            <a href="#">
                                <img src="https://htmlguru.net/carrent-html/assets/images/driver/driver-01.jpg" alt="car-item" />
                            </a>
                        </div><!-- /.vehicle-thumbnail -->
                        <div class="vehicle-bottom-content">
                ...
                <div class="item">
                    <div class="driver-content vehicle-content theme-yellow">
                        <div class="driver-thumb vehicle-thumbnail">
                            <a href="#">
                                <img src="https://htmlguru.net/carrent-html/assets/images/driver/driver-02.jpg" alt="car-item" />
                            </a>
                        </div><!-- /.vehicle-thumbnail -->
                        <div class="vehicle-bottom-content">
                           <h2 class="driver-name vehicle-title"><a href="#">Mr. Johan Smith</a></h2>
                ...
                <div class="item">
                    <div class="driver-content vehicle-content theme-yellow">
                        <div class="driver-thumb vehicle-thumbnail">
                            <a href="#">
                                <img src="https://htmlguru.net/carrent-html/assets/images/driver/driver-03.jpg" alt="car-item" />
                            </a>
                        </div><!-- /.vehicle-thumbnail -->
                        <div class="vehicle-bottom-content">
                           <h2 class="driver-name vehicle-title"><a href="#">Mr. Johan Smith</a></h2>
                ...
                <div class="item">
                    <div class="driver-content vehicle-content theme-yellow">
                        <div class="driver-thumb vehicle-thumbnail">
                            <a href="#">
                                <img src="https://htmlguru.net/carrent-html/assets/images/driver/driver-04.jpg" alt="car-item" />
                            </a>
                        </div><!-- /.vehicle-thumbnail -->
                        <div class="vehicle-bottom-content">
                           <h2 class="driver-name vehicle-title"><a href="#">Mr. Johan Smith</a></h2>
                ...
                <!-- <div class="row tb"> -->
                    <!-- <div class="col-md-6 tb-cell"> -->
                        <!-- <div class="mobile-app-details"> -->
                            ...
                            <!-- <div class="app-location-link"> -->
                                <!-- <a href="#"> -->
                                    <!-- <img src="https://htmlguru.net/carrent-html/assets/images/app-logo-one.png" alt="mobile" /> -->
                                <!-- </a> -->
                                <!-- <a href="#"> -->
                                    <!-- <img src="https://htmlguru.net/carrent-html/assets/images/app-logo-two.png" alt="mobile" /> -->
                                <!-- </a> -->
                    ...
                    <!-- <div class="col-md-6 tb-cell"> -->
                        <!-- <div class="app-mokeup"> -->
                            <!-- <img src="https://htmlguru.net/carrent-html/assets/images/mobile.png" alt="mobile" /> -->
                        <!-- </div>/.app-mokeup -->
                    <!-- </div>/.col-md-6 -->
                <!-- </div>/.row -->
            <!-- </div>/.container -->
    ...
    <div class="company-brand-block">
        <div class="container">
            ...
            <div class="brand-carousel owl-carousel">
                <a href="#" class="item">
                    <img src="https://htmlguru.net/carrent-html/assets/images/logo/logo-one.png" alt="logo" />
                </a>
            
                <a href="#" class="item">
                    <img src="https://htmlguru.net/carrent-html/assets/images/logo/logo-two.png" alt="logo" />
                </a>
            
                <a href="#" class="item">
                    <img src="https://htmlguru.net/carrent-html/assets/images/logo/logo-three.png" alt="logo" />
                </a>
            
                <a href="#" class="item">
                    <img src="https://htmlguru.net/carrent-html/assets/images/logo/logo-four.png" alt="logo" />
                </a>
            
                <a href="#" class="item">
                    <img src="https://htmlguru.net/carrent-html/assets/images/logo/logo-five.png" alt="logo" />
                </a>
            
                <a href="#" class="item">
                    <img src="https://htmlguru.net/carrent-html/assets/images/logo/logo-six.png" alt="logo" />
                </a>
            
                <a href="#" class="item">
                    <img src="https://htmlguru.net/carrent-html/assets/images/logo/logo-seven.png" alt="logo" />
                </a>
            </div><!-- /.brand-slider -->
        </div><!-- /.container -->
            ...
            <div class="vehicle-blog-slider slider-style-two owl-carousel" data-item="[3,2,1,1]">
                <div class="item">
                    <article class="post">
                        <figure class="post-thumb">
                            <a href="#">
                                <img src="https://htmlguru.net/carrent-html/assets/images/blog/blog-two.png" alt="blog" />
                            </a>
                        </figure><!-- /.post-thumb -->
                ...
                <div class="item">
                    <article class="post">
                        <figure class="post-thumb">
                            <a href="#">
                                <img src="https://htmlguru.net/carrent-html/assets/images/blog/blog-three.png" alt="blog" />
                            </a>
                        </figure><!-- /.post-thumb -->
                        <div class="post-content">  
                            <div class="entry-meta">
    ...
    <footer class="footer-block bg-black" style="background-image: url(https://htmlguru.net/carrent-html/assets/images/footer-bg.png);">
        <div class="container">
            <!-- footer-top-block -->
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="widget widget_about">    
                            ...
                            <div class="widget-about-content">
                                <img src="assets/images/taxi-malibu.jpg" alt="logo"/>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="widget widget_hot_contact">
                            ...
                            <ul>
                                <li><a href="#"><i class="fa fa-envelope"></i>radiotaximalibu@gmail.com</a></li>
                                <li><a href="#"><i class="fa fa-phone"></i>229 981 9980</a></li>
                                <li><a href="#"><i class="fa fa-map-marker"></i>AV. DE LOS NORTES 33 ALTOS.Veracruz</a></li>
                            </ul> 
                        </div><!-- /.widget -->
                        <div class="widget widget_newsletter">
                            <h3 class="widget-title">Subscribete</h3>
                            <form action="#" class="subscribes-newsletter" method="get">
                                <label>Subscribete y recibe las noticias</label>
                                <div class="input-group">
                    ...
                    <!-- <div class="col-md-4 col-sm-6"> -->
                        <!-- <div class="widget widget_photo_gallery"> -->
                            ...
                            <!-- <ul class="photo-gallery-content"> -->
                                <!-- <li> -->
                                    <!-- <a href="#"> -->
                                        <!-- <img src="https://htmlguru.net/carrent-html/assets/images/instagram/instagram-01.png" alt="instagram" /> -->
                                    <!-- </a> -->
                                <!-- </li> -->
                                <!-- <li> -->
                                    <!-- <a href="#"> -->
                                        <!-- <img src="https://htmlguru.net/carrent-html/assets/images/instagram/instagram-02.png" alt="instagram" /> -->
                                    <!-- </a> -->
                                <!-- </li> -->
                                <!-- <li> -->
                                    <!-- <a href="#"> -->
                                        <!-- <img src="https://htmlguru.net/carrent-html/assets/images/instagram/instagram-03.png" alt="instagram" /> -->
                                    <!-- </a> -->
                                <!-- </li> -->
                                <!-- <li> -->
                                    <!-- <a href="#"> -->
                                        <!-- <img src="https://htmlguru.net/carrent-html/assets/images/instagram/instagram-04.png" alt="instagram" /> -->
                                    <!-- </a> -->
                                <!-- </li> -->
                                <!-- <li> -->
                                    <!-- <a href="#"> -->
                                        <!-- <img src="https://htmlguru.net/carrent-html/assets/images/instagram/instagram-05.png" alt="instagram" /> -->
                                    <!-- </a> -->
                                <!-- </li> -->
                                <!-- <li> -->
                                    <!-- <a href="#"> -->
                                        <!-- <img src="https://htmlguru.net/carrent-html/assets/images/instagram/instagram-06.png" alt="instagram" /> -->
                                    <!-- </a> -->
                                <!-- </li> -->
                                <!-- <li> -->
                                    <!-- <a href="#"> -->
                                        <!-- <img src="https://htmlguru.net/carrent-html/assets/images/instagram/instagram-07.png" alt="instagram" /> -->
                                    <!-- </a> -->
                                <!-- </li> -->
                                <!-- <li> -->
                                    <!-- <a href="#"> -->
                                        <!-- <img src="https://htmlguru.net/carrent-html/assets/images/instagram/instagram-08.png" alt="instagram" /> -->
                                    <!-- </a> -->
                                <!-- </li> -->
                                <!-- <li> -->
                                    <!-- <a href="#"> -->
                                        <!-- <img src="https://htmlguru.net/carrent-html/assets/images/instagram/instagram-09.png" alt="instagram" /> -->
                                    <!-- </a> -->
                                <!-- </li> -->
